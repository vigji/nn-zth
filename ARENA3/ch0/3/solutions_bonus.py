...
if str(exercises_dir := Path(__file__).parent) not in sys.path:
    sys.path.append(str(exercises_dir))

import tests_ch02 as tests
from solutions_ch02 import IMAGENET_TRANSFORM, Linear, ResNet34, copy_weights
